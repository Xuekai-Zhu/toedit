...
def merge_sampled_files(input_dir, output_dir, chunk_size=1000000, target_tokens=1e9):
    ...
    for item in tqdm(all_data):
        ...
        transformed_data = {"input": text_dict["problem"],
                            "output": text_dict["solution"]}
...
if __name__ == "__main__":
    input_dir = "data/sft/ise-uiuc/Magicoder-OSS-Instruct-75K"
    output_dir = "data/sft/ise-uiuc/Magicoder-OSS-Instruct-75K-json-gz"
