...
if __name__ == "__main__":
    input_dir = "data/sft/code-data-revised/Magicoder-OSS-Instruct-75K-json-gz"
    output_dir = "data/sft/code-data-revised/Magicoder-OSS-Instruct-75K-json-gz-add-instruction"
