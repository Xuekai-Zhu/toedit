...
MODEL_PARALLEL=$4
N_GPU=$5
OUTPUT_DIR='/home/zhuxuekai/scaling_down_data/eval_results/adaptllm/output/' # for saving the prediction files
RES_DIR='/home/zhuxuekai/scaling_down_data/eval_results/adaptllm/res/' # for saving the evaluation scores of each task
CACHE_DIR='/home/zhuxuekai/scaling_down_data/eval_results/adaptllm/cache' # for caching hf models and datasets
